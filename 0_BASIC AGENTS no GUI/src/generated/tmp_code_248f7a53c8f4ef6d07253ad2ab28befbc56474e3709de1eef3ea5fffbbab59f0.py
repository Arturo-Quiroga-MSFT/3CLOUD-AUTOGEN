...
try:
    ...
    # Download adj_close with explicit argument auto_adjust=True
    nvda_data = yf.download("NVDA", start=start_date, end=end_date, progress=False, auto_adjust=True)["Close"]
    tsla_data = yf.download("TSLA", start=start_date, end=end_date, progress=False, auto_adjust=True)["Close"]
